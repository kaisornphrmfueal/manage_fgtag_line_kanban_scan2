				...
				WHERE a.tag_no = '$tagn'";
							...
							/*END BACKUP DATA TO FILE */						
								...
								if($rstg['status_tag_printing']==0){		//0=both,1=only fg Tag
										//$flgCopyDT = copy("../".DIR_UPLOAD.DIR_PRINT.$idline.".txt", "\\\\$srv\\test_tag\\print\\$idline\\fgtag.txt");
									
										//$flgCopy1 = copy("\\\\$srv\\test_tag\\print\\$idline\\cmd.txt", "\\\\$srv\\test_tag\\print\\$idline\\cmdb\\cmd.txt");
									
										//$flgCopy2 = copy("\\\\$srv\\test_tag\\print\\$idline\\cmd.txt", "\\\\$srv\\test_tag\\print\\$idline\\cmds\\cmd.txt");
							...
							// END Old			
										...
										//$flgCopyDT = copy("../".DIR_UPLOAD.DIR_PRINT.$idline.".txt", "\\\\$srv\\test_tag\\print\\$idline\\fgtag.txt");
										//$flgCopy1 = copy("\\\\$srv\\test_tag\\print\\$idline\\cmd.txt", "\\\\$srv\\test_tag\\print\\$idline\\cmdo\\cmd.txt");
