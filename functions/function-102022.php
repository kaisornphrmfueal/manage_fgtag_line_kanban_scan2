...
function selectMxTag(){
	 	$sqltg = "SELECT IFNULL(max(id_tag),0)+1  AS mxtag from ".DB_DATABASE1.".fgt_tag ";
 		$qrtg=mysql_query($sqltg);
		$rstg=mysql_fetch_array($qrtg);
		return $rstg['mxtag'];
...
function printTag($tagn){
		  $sqltg="SELECT b.id_model,b.model_code,a.tag_no,a.shift,b.model_name,b.tag_model_no,a.date_print,a.date_reprint,
					...
					b.model_picture,a.status_print,b.status_tag_printing,c.line_name,b.std_qty
				FROM ".DB_DATABASE1.".fgt_tag  a
				...
				WHERE a.id_tag = '$tagn'";
							...
							fwrite($fp,$rstg['model_code'].",".$rstg['tag_no'].",".$rstg['shift'].",".$rstg['model_name'].",".$rstg['tag_model_no'].",".$rstg['dateprint'].",".$rstg['tag_qty'].",".$rstg['allserial'].",".$rstg['line_name'].",".$rstg['dateprint'].$serialtxt.$rstg['fg_tag_barcode'].",".$rstg['customer_part_no'].",".$rstg['customer_part_name'].",".$rstg['model_picture'].",".$rstg['status_print'].",,".$rstg['std_qty'].",".$rstg['datereprint']."\r\n");
							fclose($fp);
														
							/* START BACKUP DATA TO FILE*/
							$strFileName = "tag_backup/".date('Ymd').".txt";
							$objFopen = fopen($strFileName, 'a');
							fwrite($objFopen,$rstg['model_code'].",".$rstg['tag_no'].",".$rstg['line_id'].",".$rstg['shift'].",".$rstg['model_name'].",".$rstg['tag_model_no'].",".$rstg['date_print'].",".$rstg['tag_qty'].",".$rstg['sn_start'].",".$rstg['sn_end'].",".$rstg['line_name'].",".$rstg['fg_tag_barcode'].",".$rstg['customer_part_no'].",".$rstg['customer_part_name'].",".$rstg['model_picture'].",".$rstg['status_print'].",,".$rstg['std_qty'].",".$rstg['date_reprint']."\r\n");
							fclose($objFopen);
