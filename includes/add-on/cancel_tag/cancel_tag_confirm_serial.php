...
$get_serial_info = get_serial_info(substr($fgtag_no, 0, 8));
      ...
      <div class="col-12 d-flex justify-content-center">
        <div class="card shadow-sm border-0" style="width: 80%;">
          ...
          <div class="card-body">
              ...
              <div class="row">
                <div class="col-8">
                  <label for="fgtagno" class="form-label fw-semibold text-center" style="font-size: 1rem;">สแกน Label barcode no.</label>
                    <input type="text" class="form-control bg-light" id="fgtagno" name="fgtagno" autocomplete="off" required autofocus>
                    <input type="hidden" name="transferslip" value="<?= htmlspecialchars($get_fgtag_info['tag_model_no']); ?>">
                </div>
