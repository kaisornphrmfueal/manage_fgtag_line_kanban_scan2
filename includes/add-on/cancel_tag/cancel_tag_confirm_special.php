...
if (!empty($_POST['fgtagno'])) {
  $get_fgtag = check_fgtag_no_special($_POST['fgtagno'], $_POST['transferslip']);

  if ($get_fgtag === true) {
    $check_fgtag_conversion = check_converstion_status($_POST['fgtagno']);

    if ($check_fgtag_conversion !== false) {
      gotopage('cancel_tag_confirm_serial_special.php?transferslip=' . base64_encode($_POST['transferslip']) . '&fgtagno=' . base64_encode($_POST['fgtagno']));
    } else {
      ...
      <div class="col-lg-7 col-md-9">
        <div class="card shadow-sm border-0">
          <div class="card-header bg-danger text-white">
            <h5 class="mb-0"><i class="bi bi-receipt-cutoff me-2"></i>ยืนยันการยกเลิก FGTAG Special</h5>
          </div>
          <div class="card-body">
              <div class="mb-3">
