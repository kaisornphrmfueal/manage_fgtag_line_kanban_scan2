...
<div id="header">
		<div class="row-1">
			<div class="fleft"><a href="#"><img src="../../<?=DIR_IMAGES?>logoline.png" alt="" /></a></div>
			  
				       <!-- MENU -->
                       <div class="menu">
								<?php  	require_once(DIR_MENU."menu_line.php");  ?>
                        </div>
            			<!-- MENU -->
            
				<div class="wellcome">Welcome, <?php echo $top_name= selectLineName($user_login) ;?> ||  <a href="logout.php">Logout</a> </div>
