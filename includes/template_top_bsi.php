...
include('../../includes/chk_session_bsi.php');
...
<link href="<?=HTTP_SERVER.DIR_PAGE.DIR_INCLUDES.DIR_CSS?>style_bsi.css" rel="stylesheet" type="text/css" /> <!-- WEB -->
...
<div id="header">
		<div class="row-1">
			<div class="fleft"><a href="#"><img src="../../<?=DIR_IMAGES?>logo_bsi.png" alt="" style="width:50%;height:40%;"/></a></div>
			  
				       <!-- MENU -->
                       <div class="menu">
								<?php  	require_once(DIR_MENU."menu_bsi.php");  ?>
                        </div>
            			<!-- MENU -->
            
			<div class="wellcome">Welcome, <?php echo $top_name= selectLineName($user_login) ;?> ||  <a href="logout.php?gpath=YnNpMjE4MjM=">Logout</a> </div>
