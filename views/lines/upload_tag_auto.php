...
include('../../includes/configure_srv.php');
		...
		$today=date('Y-m-d H:i:s');
			...
			while($rsck=mysqli_fetch_array($qrck)){ 
				...
				'".$rsck['date_reprint']."','System','".$today."','".$rsck['date_work']."')
				...
				shift='".$rsck['shift']."',	sn_start='".$rsck['sn_start']."', sn_end='".$rsck['sn_end']."', tag_qty='".$rsck['tag_qty']."',
					...
					date_print='".$rsck['date_print']."', who_reprint='".$rsck['who_reprint']."', date_reprint='".$rsck['date_reprint']."',
					 who_upload='System', date_upload='".$today."',date_work='".$rsck['date_work']."' ";
				...
				mysqli_query($con, "INSERT INTO ".DB_DATABASE1.".fgt_update_tag SET last_tag_id='$maxtag', line_id='',
						  status_update='System', date_update='".$today."'");
				 mysqli_query($con, "INSERT INTO ".DB_DATABASE4.".fgt_log_local_update_tag SET last_tag_id='$maxtag', line_id='',
						  status_update='System', date_update='".$today."'");
