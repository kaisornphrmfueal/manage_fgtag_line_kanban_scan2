...
<?php
		  	$today_date = date("Y-m-d H:i:s");
		   	$q="SELECT IF(a.date_print BETWEEN  (DATE_SUB('$today_date', INTERVAL 120 MINUTE)) AND ('$today_date'), 'y', 'n') AS stedit,
				b.id_model,b.model_code,a.tag_no,a.shift,b.model_name,b.tag_model_no,
			...
			$total=mysqli_num_rows($qr);  
				...
				{	
							...
							?>
                            <span style="color:#F00;">*** ข้อมูลที่สามารถแก้ไขได้คือข้อมูลที่ผลิตไม่เกิน 2 ชั่วโมง******</span>
<table width="98%" height="115" border="1" bordercolor="#CC9966"class="table01" align="center">
    ...
    <tr>
      ...
      <td>
      <?php if($rs['stedit']=='y' ){ //AND $rs['status_print']<>"Not yet" ?>
